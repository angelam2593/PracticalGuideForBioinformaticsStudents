            ...
            <div class="col-md-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold">Додади задача</h6>
                </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#input" role="tab" aria-controls="profile" aria-selected="false"><b>Тест влез</b></a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#output" role="tab" aria-controls="profile" aria-selected="false"><b>Тест излез</b></a>
                        </li>
                      </ul>
