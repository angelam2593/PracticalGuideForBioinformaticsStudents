    ...
    var Board = {
        ...
        bindUI: function() {
            ...
            $(document).on('click', "#mainkanban-btn-details", function() {
                ...
                window.location.href = "/admin/qc_old/qc_details/" + potential_id;
            });
        ...
        deleteList: function(listId, listTrash) {
            ...
            swal({
                ...
                $.ajax({
                    url: '/admin/kanban_old/board/delete-list',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        listId: listId
        ...
        updateTaskCompleted: function(taskId, isCompleted) {
            var cardId = $(document).find('#card-detail').attr("data-cardid");
            $.ajax({
                url: '/admin/kanban_old/board/update-task-completed',
                type: 'POST',
                dataType: 'json',
                data: {
                    taskId: taskId,
        ...
        archiveTask: function(cardId) {
            ...
            swal({
                ...
                $.ajax({
                    url: '/admin/kanban_old/board/archive-task',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        cardId: cardId
        ...
        saveTask: function(taskTitle, cardId) {
            var that = this;
            $.ajax({
                url: '/admin/kanban_old/board/save-task',
                type: 'POST',
                dataType: 'json',
                data: {
                    taskTitle: taskTitle,
        ...
        postComment: function(comment, cardId) {
            var that = this;
            $.ajax({
                url: '/admin/kanban_old/board/save-comment',
                type: 'POST',
                dataType: 'json',
                data: {
                    comment: comment,
        ...
        saveMainKanbanTaskChanges: function(cardId) {
            ...
            $.ajax({
                url: '/admin/kanban_old/board/update-mainkanban-card-data',
                type: 'POST',
                dataType: 'json',
                data: {
                    cardColor: cardColor,
        ...
        saveChanges: function(cardId) {
            ...
            $.ajax({
                url: '/admin/kanban_old/board/update-card-data',
                type: 'POST',
                dataType: 'json',
                data: {
                    cardName: cardName,
        ...
        deleteTask: function(taskId, deleteTaskBtn) {
            ...
            swal({
                ...
                $.ajax({
                    url: '/admin/kanban_old/board/delete-task',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        taskId: taskId,
        ...
        deleteTimesheetEntry: function(timesheet_id) {
            swal({
                ...
                function() {
                    $.ajax({
                        url: '/admin/kanban_old/timesheet/postDeleteTimesheetEntry',
                        type: 'POST',
                        dataType: 'json',
                        data: {
        ...
        submitNewTimesheet: function(params) {
            var that = this;
            $.ajax({
                url: '/admin/kanban_old/timesheet/postSubmitNewTimesheetEntry',
                type: 'POST',
                dataType: 'json',
                data: {
                    params: params
        ...
        putMainKanbanCardDetailInModal: function(cardId) {
            ...
            $.ajax({
                url: '/admin/kanban_old/board/getMainKanbanCardDetail',
                type: 'POST',
                dataType: 'json',
                data: {
                    cardId: cardId
                ...
                success: function(data) {
                    ...
                    if (data.qc_details.assignedTo) {
                        $("#mainkanban_card_dp").text("DP - " + data.qc_details.assigned_to.first_name + " " + data.qc_details.assigned_to.last_name);
                    } else {
                        $("#mainkanban_card_dp").text("DP - No data processor is selected");
                    }
        ...
        putCardDetailInModal: function(cardId) {
            var that = this;
            $.ajax({
                url: '/admin/kanban_old/board/getCardDetail',
                type: 'POST',
                dataType: 'json',
                data: {
                    cardId: cardId
        ...
        deleteCard: function(cardId, cardIdCon) {
            ...
            swal({
                ...
                $.ajax({
                    url: '/admin/kanban_old/board/deleteCard',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        cardId: cardId
        ...
        saveCard: function(data, curentBtnClicked) {
            var that = this;
            $.ajax({
                url: '/admin/kanban_old/board/postCard',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(data) {
        ...
        saveBoard: function() {
            ...
            $.ajax({
                url: '/admin/kanban_old/postBoard',
                type: 'POST',
                dataType: 'json',
                data: {
        ...
        createActivity: function(activity_in_id, changed_in, activity_description) {
            $.ajax({
                url: '/admin/kanban_old/create-user-activity',
                type: 'POST',
                dataType: 'json',
                data: {
        ...
        savePublicList: function(data, curentBtnClicked) {
            that = this;
            $.ajax({
                url: '/admin/kanban_old/board/postListName',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(data) {
